...
term = factor { ("*" | "/" | "%") factor } # Added modulus symbol
...
def parse_term(tokens):
    ...
    while tokens[0]["tag"] in ["*", "/","%"]: # Added modulus
        tag = tokens[0]["tag"]
...
def test_modulus_parsing(): # Added modulus test
...
if __name__ == "__main__":
    ...
    test_modulus_parsing() # Added modulus test
